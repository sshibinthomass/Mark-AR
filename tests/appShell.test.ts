...
describe('renderAppShell', () => {
  it('renders the target-focused workflow', () => {
    ...
    expect(markerStage?.parentElement).toBe(scannerPanel);
    expect(floorStage?.parentElement).toBe(scannerPanel);
    expect(floorOverlay?.parentElement).toBe(scannerPanel);
